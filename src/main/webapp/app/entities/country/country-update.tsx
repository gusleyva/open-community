  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="opencommunityApp.country.home.createOrEditLabel">
            <Translate contentKey="opencommunityApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
