  ...
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="opencommunityApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="opencommunityApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('opencommunityApp.country.home.search')}
                />
        ...
        {countryList && countryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="opencommunityApp.country.countryName">Country Name</Translate>
                </th>
                <th>
                  <Translate contentKey="opencommunityApp.country.region">Region</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="opencommunityApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
