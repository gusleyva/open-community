  ...
  return (
    <div>
      <h2 id="region-heading">
        <Translate contentKey="opencommunityApp.region.home.title">Regions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="opencommunityApp.region.home.createLabel">Create new Region</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('opencommunityApp.region.home.search')}
                />
        ...
        {regionList && regionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="opencommunityApp.region.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="opencommunityApp.region.home.notFound">No Regions found</Translate>
            </div>
          )
        )}
      </div>
