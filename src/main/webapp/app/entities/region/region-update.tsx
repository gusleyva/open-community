  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="opencommunityApp.region.home.createOrEditLabel">
            <Translate contentKey="opencommunityApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
