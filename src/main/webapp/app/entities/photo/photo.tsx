...
import { getSearchEntities, getEntities } from './photo.reducer';
...
export const Photo = (props: IPhotoProps) => {
  ...
  return (
    <div>
      <h2 id="photo-heading">
        <Translate contentKey="opencommunityApp.photo.home.title">Photos</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="opencommunityApp.photo.home.createLabel">Create new Photo</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('opencommunityApp.photo.home.search')}
                />
        ...
        {photoList && photoList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="opencommunityApp.photo.home.notFound">No Photos found</Translate>
            </div>
          )
        )}
      </div>
